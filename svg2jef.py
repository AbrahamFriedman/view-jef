...
from PyQt5.QtCore import QCoreApplication, QXmlStreamReader
            ...
            if c in u"-0123456789.e":
                ...
                if self.Commands.has_key(c):
                    ...
                    if len(args) != 0 and len(args) != arg_number:
                        sys.stderr.write(
                            "Unexpected number of arguments in preceding command at line %i; column %i: '%s'\n" % (
